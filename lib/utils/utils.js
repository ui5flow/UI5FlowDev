                ...
                request(adtConfig, function(error, response, body) {
                    if (!error && response.statusCode == 200) {
                        ...
                        if (response.statusCode == 404) {
                            logger.warning('Warning:', 'Resource not found');
                    ...
                    switch (syncData.syncMode) {
                        case 'create':
                            ...
                            fs.readFile(syncData.name, function(error, data) {
                                ...
                                //logger.debug('Requesting POST:', adtConfig.url);
                        ...
                        case 'update':
                            ...
                            fs.readFile(syncData.name, function(error, data) {
                                ...
                                //logger.debug('Requesting PUT:', adtConfig.url);
    ...
    buildComponentPreload: function(appName, versionExtId, pathPrefix, srcRepoPath) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            preloadFiles.forEach(function(preloadFile) {
                ...
                var componentFilePath = path.join(process.env.VERSIONS_DIR, versionExtId, process.env.DIST_VERSION_DIR, preloadInfo.moduleName + preloadInfo.ext);
